...
import { addHandicraft } from '../actions/handicraftActions'
import {useDispatch, useSelector} from 'react-redux'
import Error from '../components/Error'
import Loading from '../components/Loading'
import Success from '../components/Success'

export default function Addhandicraft() {
    ...
    const addhandicraftstate = useSelector(state => state.addHandicraftReducer)
    const{success, error, loading} = addhandicraftstate
    ...
    return (
        <div>
            ...
            <form onSubmit={formHandler}>
                ...
                <button className='btn mt-3' tyoe='submit'>Add Handicraft</button>
            </form>
            </div>
        </div>
    )
